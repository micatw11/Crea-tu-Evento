                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        ...
                                        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                            Se le ha dado de baja al proveedor <b>{{ $reserva->publicacion->proveedor->nombre}}</b>, por lo que se ha cancelado su reserva de <b>{{ $reserva->publicacion->titulo}}</b>.
                                        </p>
                                        <h4>A continuaci&oacute;n se especifica el motivo por el cual se le ha dado de baja</h4>
                                        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                            {{ $reserva->publicacion->proveedor->observaciones }}
                                        </p>
